...
-(NSString *)base64String
{
    ...
    return [NSString base64StringFromData:utf8encoding];
}

-(NSString *)base64UrlEncodedString
{
    return [[self class] base64UrlEncodedStringFromBase64String:[self base64String]];
}

+(NSString *)stringFromBase64String:(NSString *)base64String
{
    NSData *utf8encoding = [NSData dataFromBase64String:base64String];
...
{
    return [self stringFromBase64String:[NSString base64StringFromBase64UrlEncodedString:base64UrlEncodedString]];
}
...
{
    return [[self class] dataFromBase64String:[[self class] base64StringFromBase64UrlEncodedString:base64UrlEncodedString]];
}
...
-(NSString *)base64String
{
    return [NSString base64StringFromData:self];
}
